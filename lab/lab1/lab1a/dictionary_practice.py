...
'''
# YOUR CODE HERE
if 4 in number_dict['cs251']:
    idx = number_dict['cs251'].index(4)
    print('The index of the 4 is', idx)
else:
    print('4 not found')
...
# YOUR CODE HERE
dic = {'shoe_store': [], 'music_store': []}
for i in delivery:
    if i == 'shoes':
        dic['shoe_store'].append(i)
    else:
        dic['music_store'].append(i)
    print(dic['shoe_store'])
    print(dic['music_store'])
